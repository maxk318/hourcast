...
// A blue tank centered at c: rounded bottom corners, wavy top surface,
...
static void draw_tide_cell(GContext *ctx, GPoint c, int S, int pct, int32_t phase) {
  ...
  // 3. Rocky border: side walls stop CORNER_R above bottom; bottom wall with rounded corners
